...
if (isset($_GET['kodesupplier'])) {
    ...
    $query_produk = "SELECT kodeproduk, namaproduk, spesifikasi, satuan, tanggal, jumlah, harga, tanggal2, jumlah2, harga2, fotoproduk, fotoproduk2 FROM produksupplier WHERE kodesupplier = '$kodesupplier'";
    ...
    if (mysqli_num_rows($result_produk) == 0) {
        die("Tidak ada produk ditemukan untuk kode pelanggan '$kodesupplier'");
    }
    ...
    function confirmDelete(kodeproduk) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'deleteproduksupplier.php?kodeproduk=' + kodeproduk;
            }
        });
    }
</script>
...
<a class="btn btn-sm btn-neutral" href="masukkeproduksupplier.php?kodesupplier=<?php echo $kodesupplier; ?>">+ Data Produk</a>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header border-0">
                        <h3 class="mb-0">Data Produk <?php echo $kodesupplier; ?></h3>
                    </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    while ($row_produk = mysqli_fetch_assoc($result_produk)) {
                                        ...
                                        $query_kelompok = "SELECT kelompokproduk, jumlah, tanggalcek, keterangan FROM kelompoksupplier WHERE kodeproduk = '$kodeproduk'";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row_produk['spesifikasi']; ?></td>
                                            <td>
                                                ...
                                                <div class="modal fade" id="detailPelangganModal<?php echo $row_produk['kodeproduk']; ?>"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <h1 class="modal-title" id="detailPelangganModalLabel">
                                                                Detail Produk <?php echo $row_produk['kodeproduk']; ?>
                                                            </h1>
                        ...
                        <td>Foto produk:</td>
                            <?php 
                                ...
                                ?>
                            <td><a href="previewpsupplier.php?fotoproduk=<?php echo urlencode($row_produk['fotoproduk']); ?>" target="_blank" style="color:#6cb3fd;">Pratinjau</a></td>
                        </tr>
                        <tr>
                            <td>Foto Produk 2:</td>
                            <?php 
                                ...
                                echo '<img src="' . $foto_produk . '" alt="Foto Produk" style="max-width: 200px; max-height: 200px;">'; 
                                ?>
                            <td><a href="previewpsupplier.php?fotoproduk=<?php echo urlencode($row_produk['fotoproduk2']); ?>" target="_blank"style="color:#6cb3fd;">Pratinjau</a></td>
                        </tr>
                                                                </table>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button"  id="detailPelangganModalLabel"class="btn btn-danger"
