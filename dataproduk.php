...
if (isset($_GET['kodepelanggan'])) {
    ...
    $query_produk = "SELECT kodeproduk, namaproduk, spesifikasiproduk, satuan, tanggal, jumlah, harga, tanggal2, jumlah2, harga2, fotoproduk, fotoproduk2 FROM produk WHERE kodepelanggan = '$kodepelanggan'";
