...
if (isset($_GET['kodeproduk'])) {
    ...
    $query = "SELECT fotoproduk FROM produk WHERE kodeproduk = '$kodeproduk'";
    ...
    $deleteProdukQuery = "DELETE FROM produk WHERE kodeproduk = '$kodeproduk'";
    
    // Buat query SQL untuk menghapus data dari tabel kelompok berdasarkan kodeproduk
    $deleteKelompokQuery = "DELETE FROM kelompok WHERE kodeproduk = '$kodeproduk'";
