...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlPenjualan = "INSERT INTO penjualan (PenjualanID, TanggalPenjualan, SubTotal) VALUES ('$id_penjualan', '$tanggal_penjualan', '$subtotal_harga')";
...
<style>
    ...
    input[type="date"] {
      ...
      background-color: #2ecc71; /* Ubah warna latar belakang menjadi hijau */
      color: #fff; /* Ubah warna teks menjadi putih */
      border: 1px solid #2ecc71; /* Sesuaikan warna border dengan latar belakang */
      border-radius: 4px;
      cursor: pointer;
    }

    .btn:hover {
      background-color: #27ae60; /* Sesuaikan warna hover dengan latar belakang */
    }
  ...
  <form method="post" id="form">
    <div class="form">
      ...
      <div class="form-group">
        ...
        <input type="text" readonly id="subtotal-data" class="form-control" placeholder="Harga Produk">
        <input type="hidden" id="subtotal_data" name="subtotal_data" class="form-control" placeholder="Harga Produk">
      </div>

      <!-- Tombol untuk membuka pop-up form -->
      <button type="button" id="open-popup-btn" class="btn btn-primary">Next</button>
<br>
