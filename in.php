...
<script>
    ...
    // Fungsi untuk menghitung subtotal otomatis di dalam modal saat produk dipilih
    function updateSubTotalModal() {
        ...
        document.getElementById("subTotalModal").innerHTML = "Subtotal: " + subTotal;
    }

    // Fungsi untuk menambahkan produk dari modal ke form utama
    function tambahkanProduk() {
        ...
        var jumlahProduk = document.getElementById("jumlahProduk").value;
        var subTotal = parseFloat(document.getElementById("produkID").options[document.getElementById("produkID").selectedIndex].getAttribute('data-harga')) * jumlahProduk;

        // Menambahkan data produk ke dalam form utama
        var newItem = document.createElement("div");
        newItem.innerHTML = "Detail ID: <input type='text' value='" + generateDetailID() + "' readonly> - Penjualan ID: <input type='text' value='" + document.getElementById("PenjualanID").value + "' readonly> - Produk: " + produkNama + " (ID: " + produkID + ") - Jumlah: " + jumlahProduk + " - Subtotal: " + subTotal;
        document.getElementById("produkList").appendChild(newItem);

        // Mengosongkan nilai input di modal setelah menambahkan produk
        document.getElementById("jumlahProduk").value = "";
        document.getElementById("subTotalModal").innerHTML = "";
    }

    // Fungsi untuk menghasilkan ID detail baru
    function generateDetailID() {
        // Kode untuk menghasilkan ID detail baru
    }
    ...
    var newItem = document.createElement("div");
    newItem.innerHTML = produkNama + " (ID: " + produkID + ") - Jumlah: " + jumlahProduk;
    document.getElementById("produkList").appendChild(newItem);

    // Hitung subtotal dan update tampilan
    updateSubTotal();
}
...
<script>
    function addProduct() {
        ...
        document.getElementById("selectedProducts").appendChild(newItem);
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahProdukModal">Tambah Produk</button>
      ...
      <div class="modal-body">
        <form id="formTambahProduk">
          <div class="form-group">
            ...
            <select class="form-control" id="produkID"onchange="updateSubTotal()">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="jumlahProduk" placeholder="Jumlah produk">
          </div>
          <div class="form-group">
            <label for="jumlahProduk">SubTotal:</label>
            <input type="number" class="form-control" id="SubTotal" placeholder="Subtotal"onchange="updateSubTotal()" readonly>
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
        <button type="button" class="btn btn-primary" onclick="tambahProduk()">Tambahkan</button>
      </div>
    </div>
  </div>
</div>
