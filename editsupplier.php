...
$kodesupplier = $namasupplier = $alamatkantor = $alamatpengiriman = $kontakperson = $email = $website = $npwp = $catatan = $tanggalupdate = "";
$proposal = "";
...
if (isset($_POST['submit'])) {
    ...
    // Query untuk melakukan update dat
    $query_update = "UPDATE supplier SET kodesupplier='$kodesupplier', namasupplier='$namasupplier', alamatkantor='$alamatkantor', alamatpengiriman='$alamatpengiriman', kontakperson='$kontakperson', email='$email', website='$website',npwp='$npwp', catatan='$catatan', tanggalupdate='$tanggalupdate' WHERE kodesupplier='$kodesupplier'";
      ...
      <div class="col-md-8 offset-md-2">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                          ...
                          <input type="text" name="kodesupplier" value="<?php echo $row['kodesupplier'] ?>" placeholder=" Nama Produk " class="form-control"readonly>
                      </div>
                      
                      <div class="form-group">
                          <label>Nama Supplier</label>
                          <input type="text" name="namasupplier" value="<?php echo $row['namasupplier'] ?>" placeholder=" Nama Produk " class="form-control">
                      </div>
                      <div class="form-group">
                          <label>Alamat Kantor</label>
                          <input type="text" name="alamatkantor" value="<?php echo $row['alamatkantor'] ?>" placeholder="harga" class="form-control">
                      </div>
                      ...
                      <div class="form-group">
                          <label>email</label>
                          <input type="text" name="email" value="<?php echo $row['email'] ?>" placeholder="Stok" class="form-control">
                      </div>
                      <div class="form-group">
                          <label>Website</label>
                          <input type="text" name="website" value="<?php echo $row['website'] ?>" placeholder="Stok" class="form-control">
                      </div>
