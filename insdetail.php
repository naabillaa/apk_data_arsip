...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    for ($i = 0; $i < count($produk_ids); $i++) {
        ...
        $sqlDetailPenjualan = "INSERT INTO detail_penjualan (DetailID, ProdukID, JumlahProduk, TotalHarga) VALUES ('$id_detail', '$id_produk', '$jumlah_produk', '$subtotal')";
  ...
  <form method="post" id="form">
    <div class="form">
      ...
      <div class="form-group">
        ...
        <input type="hidden" id="subtotal_data" name="total_harga" class="form-control" placeholder="Harga Produk">
      </div>
