...
if(isset($_POST['submit'])){
  ...
  $query_update = "UPDATE penjualan SET TanggalPenjualan='$TanggalPenjualan', TotalHarga='$TotalHarga' WHERE PenjualanID='$PenjualanID'";
              ...
              <div class="card-body">
                  <form action="" method="POST">
                      ...
                      <div class="form-group">
                          ...
                          <input type="date" name="TanggalPenjualan" value="<?php echo $row['TanggalPenjualan'] ?>" placeholder=" Nama Produk " class="form-control">
                          <input type="hidden" name="PenjualanID" value="<?php echo $row['PenjualanID'] ?>">
                      </div>

                      <div class="form-group">
                          <label>TotalHarga</label>
                          <input type="number" name="TotalHarga" value="<?php echo $row['TotalHarga'] ?>" placeholder="TotalHarga" class="form-control">
                      </div>
